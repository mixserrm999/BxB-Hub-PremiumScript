...
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/BxB-HUB/BxB-Hub-PremiumScript/main/BxB-Script/Race-Clicker/library.lua"))()
...
Credit:NewLabel("Made By Boom WrkSs")
