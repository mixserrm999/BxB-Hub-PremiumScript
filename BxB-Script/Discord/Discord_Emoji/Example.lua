...
local selected = 0
local chatbox
local emojil = game:GetService("HttpService"):JSONDecode(game:HttpGet('https://raw.githubusercontent.com/BxB-HUB/BxB-Hub-PremiumScript/main/BxB-Script/Discord/Discord_Emoji/Code/Emoji_Strategy.json', true))
local emotes = {}
local emojis = {}
local unicode = loadstring(game:HttpGet(('https://raw.githubusercontent.com/BxB-HUB/BxB-Hub-PremiumScript/main/BxB-Script/Discord/Discord_Emoji/Code/Unicode.lua'),true))()
