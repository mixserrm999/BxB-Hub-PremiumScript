...
information:CreateButton("Discord Invite", function() setclipboard("Don't have") end)
information:CreateButton("Donation", function() setclipboard("https://www.paypal.com/paypalme/BOOMOZ") end)
