...
local CodeApi = loadstring(game:HttpGet('https://raw.githubusercontent.com/BxB-HUB/BxB-Hub-PremiumScript/main/BxB-Script/Blox-Fruit/UNIQUE/Code_Api.lua'))()
...
--[Create Variables UI]
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/BxB-HUB/BxB-Hub-PremiumScript/main/BxB-Script/Blox-Fruit/UNIQUE/library.lua"))()
...
function WebHookLog:WebHookKaiTanSend(WebHookUrl)
	...
	local Embeds = {{
		["title"] = "**BxB.xyz Hub Webhooks Status**",
