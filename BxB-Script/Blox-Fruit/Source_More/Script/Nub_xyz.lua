...
Notification.new("<Color=Cyan>BxB.xyz | Community!<Color=/>"):Display()
Notification.new("<Color=Red>[ System ] <Color=/> - <Color=Green>Script Loading...<Color=/>"):Display()
Notification.new("<Color=Red>[ System ] <Color=/> - <Color=Green>Change Logs<Color=/>  (+ Fix Script not loaded)"):Display()
...
local Library = Update:Window("BxB","",Enum.KeyCode.RightControl);
...
local logs = "[+] Removed Bugs From Mastery Farm"

main:Label("Welcome "..game.Players.LocalPlayer.DisplayName.. " To BxB HUB")
main:Label("By Boom WrkSs")
...
setclipboard("https://discord.gg/nCgTxJvU4g")
local Module = loadstring(game:HttpGet("https://raw.githubusercontent.com/BxB-HUB/BxB-Hub-PremiumScript/main/BxB-Script/Blox-Fruit/Main/Discord-inv/INV.lua"))()

Module.Prompt({ invite = "nCgTxJvU4g", name = "BxB.xyz"}) 
...
Main:Toggle("AutoFarm Level",_G.AutoFarm,function(value)
	...
	Main:Toggle("AutoFarm Bone", _G.Auto_Bone,function(value)
    _G.Auto_Bone = value
        StopTween(_G.Auto_Bone)
    end)
		Main:Toggle("AutoFarm Ectoplasma",false,function(A)
  _G.AutoEctoplasm = A
...
set:Toggle("Lock Level Farm",locklevel,function(value)
    ...
    _G.Kill_At = 1
	    local SelectWeapona = Main:Dropdown("Select DevilFruit",WeaponList,function(value)
        _G.SelectWeapon1 = value
    end)
    ...
    Main:Toggle("Auto Farm Gun Mastery",_G.AutoFarmGunMastery,function(value)
      ...
      Main:Label("Note:To Work Change the Slider, Do Not Activate Auto Farm When Auto Mastery is On ")
...
_G.Ore = false
  ...
  -- Main:Seperator("Misc Mastery")
    ...
    spawn(function()
        ...
        iain:Seperator("Oder Sword")
    
    iain:Toggle("Auto Oder Sword (New !)", _G.AutoOderSword,function(value)
    ...
    iain:Button("Buy Microchip Oder Boss",function()
    local args = {
       [1] = "BlackbeardReward",
       [2] = "Microchip",
       [3] = "2"
    ...
    iain:Button("Start Go To Raid Oder Boss",function()
        if World2 then
    ...
    iain:Seperator("Legendary Sword")
    
    iain:Toggle("Auto Legendary Sword",_G.AutoBuyLegendarySword,function(value)
    ...
    iain:Toggle("Auto Legendary Sword Hop",_G.AutoBuyLegendarySword_Hop,function(value)
...
Misc:Button("Color Haki",function()
    ...
    Misc:Button("Unlock FPS",function()
     ...
     Misc:Button("Fake Skin MODEÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬ ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¾ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢",function()
	 spawn(function()
     pcall(function()
     while true do
     wait(.0)
