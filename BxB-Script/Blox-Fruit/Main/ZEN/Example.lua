...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/BxB-HUB/BxB-Hub-PremiumScript/main/BxB-UI/Zen_library.lua"))()
local Wait = library.subs.Wait

local PepsisWorld = library:CreateWindow({
    Name = "BxB.xyz | Premium",
    Themeable = {
    Info = "Discord Server: "
    }
})
...
MainSection:AddDropdown({
    ...
    List = {"Normal Mode","Fast Mode","No Quest","Near Farm Mode","Fruit Mastery Mode","Gun Mastery Mode","Near Farm Mode"},
...
MainSection:AddToggle({
    Name = "Farm Selected Mode",
    Flag = "Farm_Selected_Mode",
...
elseif _G.SelectModeFarm == "Near Farm Mode" then
  for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
  if v.Name and v:FindFirstChild("Humanoid") then
  if v.Humanoid.Health > 0 then
  repeat game:GetService("RunService").Heartbeat:wait()
...
SettingSection:AddSlider({
    ...
    Format = function(value)
		...
		saveSettings()
		return "Distance [For Farm]: " .. tostring(value)
    end
})
...
SettingSection:AddSlider({
    ...
    Format = function(value)
		...
		saveSettings()
		return "Kill At: ".. tostring(value).." [For Mastery Farm]"
    end
})
...
OtherSection:AddToggle({
    Name = "Auto Cdk Quest",
    Flag = "Auto_Dual_Curse_Katana",
    Value = _G.Settings.AutoCdk,
    Callback = function(value)
       _G.AutoCdk = value    
...
local Others = MainTab:CreateSection({
		Name = "Other",
		Side = "Right"
	})
...
local MainDungeonSection1 = DungeonTab:CreateSection({
    Name = "Esp",
	Side = "Left"
})

MainDungeonSection1:AddToggle({
    Name = "ESP Player",
    Flag = "ESP_Player",
    Value = false,
    Callback = function(value)
...
local race = MiscTab:CreateSection({
	Name = "Fake Race V4",
	Side = "Right"
   })

   local codesi = MiscTab:CreateSection({
	Name = "Codes",
	Side = "Left"
   })
