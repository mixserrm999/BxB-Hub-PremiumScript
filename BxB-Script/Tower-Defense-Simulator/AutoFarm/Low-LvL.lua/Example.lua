local TDS = loadstring(game:HttpGet("https://raw.githubusercontent.com/BxB-HUB/BxB-Hub-PremiumScript/main/BxB-Script/Tower-Defense-Simulator/AutoFarm/Low-LvL.lua/TDS-Load.lua", true))()
