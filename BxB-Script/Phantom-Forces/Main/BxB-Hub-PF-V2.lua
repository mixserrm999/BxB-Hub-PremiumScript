...
function menu.Initialize(menutable)
	...
	do
		...
		Draw:MenuBigText(MenuName or "BxB Hub | Phantom Force", true, false, 6, 6, bbmenu)
		...
		if menu then
			...
			if menu.open then
				if menu.tabnames[menu.activetab] == "Settings" then
					local menutext = menu:GetVal("Settings", "Cheat Settings", "Custom Menu Name") and menu:GetVal("Settings", "Cheat Settings", "MenuName") or "BxB Hub | Phantom Force"
							...
							content = {
								{
									...
									name = "Enabled",
									value = false,
									tooltip = "Allows BxB Hub to modify weapons.",
								},
								{
									type = SLIDER,
						...
						},
						{
							...
							content = {
								...
								},
								{
									type = TEXTBOX,
									name = "MenuName",
									text = MenuName or "BxB Hub | Phantom Force",
								},
								{
									type = BUTTON,
