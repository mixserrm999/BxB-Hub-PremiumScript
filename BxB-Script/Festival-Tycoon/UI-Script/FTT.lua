--updated
do local GUI = game.CoreGui:FindFirstChild("BXBHUB");if GUI then GUI:Destroy();end;if _G.Color == nil then
...
function Update:Window(text,logo,keybind)
 ...
 local BXBHUB = Instance.new("ScreenGui")
 BXBHUB.Name = "BXBHUB"
 BXBHUB.Parent = game.CoreGui
 BXBHUB.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
 ...
 Hub.Text = "HUB"
 Hub.TextColor3 = Color3.fromRGB(255, 89, 89)
 Hub.TextSize = 17.000
...
local Library = Update:Window(" BxB  |","HUB",Enum.KeyCode.RightControl);
Main = Library:Tab("Main")

Main:Line()

Main:Label("Welcome [ "..game.Players.LocalPlayer.Name.." ] To BxB Hub")
...
Main:Seperator("Change Logs")
Main:Label(" [*] Update  16/9/2022 \n     | - Add Buy All Button \n     | - Add Information select")
Main:Seperator("Main Features")



Main:Button("Finish Tycoon",function()
...
Main:Button("INF money + 1 badge",function()
    local args = {
        [1] = math.huge
    }
...
Main:Button("Get Badges",function()
...
Main:Button("Get BodyGuard Badge [CLICK 4 TIMES]",function()
    local args = {
        [1] = "Mooshu"
    }
...
Main:Line()
Main:Button("Buy all Buttons",function()
...
Info = Library:Tab("Information")
Info:Label("--[[ ================== CREDIT ================== ]]--")
Info:Label(" UI  | [*]  Boom WrkSs")
Info:Label("Scripter  | [*]  Boom WrkSs")
Info:Label("--[[ ============================================ ]]--")
