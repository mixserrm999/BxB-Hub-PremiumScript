...
do local GUI = game.CoreGui:FindFirstChild("SOMEXHUB");if GUI then GUI:Destroy();end;if _G.Color == nil then
       _G.Color = Color3.fromRGB(202,60,253)
   end 
end
...
function Update:Window(text,logo,keybind)
	...
	Logo.Image = "rbxassetid://10247845051"
	...
	Hub.Text = "HUB|Premium"
	Hub.TextColor3 = Color3.fromRGB(202,60,253)
	Hub.TextSize = 17.000
	...
	function uitab:Tab(text)
		...
		function main:Button(text,callback)
			...
			Button.BackgroundColor3 = Color3.fromRGB(202,60,253)
		...
		function main:Toggle(text,config,callback)
			...
			Toggle.BackgroundColor3 = Color3.fromRGB(202,60,253)
			...
			Button.MouseButton1Click:Connect(function()
				if toggled == false then
					...
					TweenService:Create(
						Circle,
						TweenInfo.new(0.4,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
						{BackgroundColor3 = Color3.fromRGB(202,60,253)}
					):Play()
				else
					toggled = false
		...
		function main:Slider(text,min,max,set,callback)
			...
			Slider.BackgroundColor3 = Color3.fromRGB(202,60,253)
			...
			bar1.Name = "bar1"
			bar1.Parent = bar
			bar1.BackgroundColor3 = Color3.fromRGB(202,60,253)
			...
			slidervalue.BackgroundColor3 = Color3.fromRGB(202,60,253)
		...
		function main:Textbox(text,disappear,callback)
			...
			Textbox.BackgroundColor3 = Color3.fromRGB(202,60,253)
		...
		function main:Seperator(text)
			...
			Sep1.BackgroundColor3 = Color3.fromRGB(202,60,253)
			...
			Sep3.BackgroundColor3 = Color3.fromRGB(202,60,253)
		...
		function main:Line()
			...
			Line.Name = "Line"
			Line.Parent = Linee
			Line.BackgroundColor3 = Color3.fromRGB(202,60,253)
...
local Library = Update:Window("Goots","6023426909",Enum.KeyCode.RightControl);
Main = Library:Tab("Main","6023426909")
M = Library:Tab("Combat Tab")
ItemTab = Library:Tab("ItemTab")
...
Setting = Library:Tab("Setting Farm")


Main:Label("Welcome To ScriptBF")
...
Main:Seperator("AutoFarmMode Farm")
                ...
                if _G.BringMonster then
                    ...
                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        -- for x,y in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == Ms and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 350 then
                                -- if  y.Name == Ms and y:FindFirstChild("Humanoid") and y:FindFirstChild("HumanoidRootPart") and (y.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 350 then
                                    if syn then
                                        if isnetworkowner(v.Head) or isnetworkowner(v.HumanoidRootPart) then
...
spawn(function()
    ...
    Setting:Toggle("Very Fast Attack",nil,function(value)
...
spawn(function()
   ...
   Setting:Toggle("Delete Animetion fix",nil,function(d)
    _G.DeleteAttackFx = d
...
Setting:Seperator("Misc Setting Mastery")
    ...
    Main:Seperator("AutoFarm Mastery")
    ...
    ItemTab:Seperator("Misc Buddy Sword")
    
    ItemTab:Toggle("Auto Buddy Sword",_G.AutoBudySword,function(value)
        _G.AutoBudySword = value
        StopTween(_G.AutoBudySword)
    end)
    
    ItemTab:Toggle("Auto Buddy Sword Hop",_G.AutoBudySwordHop,function(value)
    ...
    ItemTab:Seperator("Misc OderSword")
    
    ItemTab:Toggle("Auto OderSword", _G.AutoOderSword,function(value)
         _G.AutoOderSword = value
        StopTween( _G.AutoOderSword)
    end)
    
    ItemTab:Toggle("Auto OderSwordHob", _G.AutoOderSwordHop,function(value)
    ...
    ItemTab:Button("Buy Microchip Oder Boss",function()
    local args = {
       [1] = "BlackbeardReward",
       [2] = "Microchip",
       [3] = "2"
...
ItemTab:Button("Start Goto RaidOderBoss",function()
        if World2 then
            fireclickdetector(game:GetService("Workspace").Map.CircleIsland.RaidSummon.Button.Main.ClickDetector)
        end
    end)
    
    P:Seperator("Misc Elite")
    
    local EliteProgress = P:Label("")
    ...
    P:Toggle("Auto Elite Hunter",_G.AutoElitehunter,function(value)
    ...
    P:Toggle("Auto Elite Hunter Hop",_G.AutoEliteHunterHop,function(value)
        _G.AutoEliteHunterHop = value
    end)
    
    ItemTab:Seperator("Seperator Hallow Scythe")
    
    ItemTab:Toggle("Auto Hallow Scythe",_G.AutoFarmBossHallow,function(value)
        _G.AutoFarmBossHallow = value
        StopTween(_G.AutoFarmBossHallow)
    end)
    
    ItemTab:Toggle("Auto Hallow Scythe Hop",_G.AutoFarmBossHallowHop,function(value)
    ...
    ItemTab:Seperator("Dark Dagger")
    
    ItemTab:Toggle("Auto Kill Admin Boss",_G.AutoDarkDagger,function(value)
    ...
    ItemTab:Toggle("Auto Kill Admin Boss Hop",_G.AutoDarkDagger_Hop,function(value)
    ...
    ItemTab:Seperator("Misc Swan Glasses")
    
    ItemTab:Toggle("Auto Swan Glasses",_G.AutoFarmSwanGlasses,function(value)
    ...
    ItemTab:Toggle("Auto Swan Glasses Hop",_G.AutoFarmSwanGlasses_Hop,function(value)
    ...
    ItemTab:Seperator("Saber")
    
    ItemTab:Toggle("Auto Saber",_G.AutoSaber,function(value)
        _G.AutoSaber = value
        StopTween(_G.AutoSaber)
    end)
    
    ItemTab:Toggle("Auto Saber Hop",_G.AutoSaber_Hop,function(value)
    ...
    ItemTab:Seperator("Legendary Sword")
    
    ItemTab:Toggle("Auto Legendary Sword",_G.AutoBuyLegendarySword,function(value)
    ...
    ItemTab:Toggle("Auto Legendary Sword Hop",_G.AutoBuyLegendarySword_Hop,function(value)
    ...
    ItemTab:Toggle("Auto Rengoku",_G.AutoRengoku,function(value)
    ...
    ItemTab:Toggle("Auto Yama",_G.AutoYama,function(value)
        _G.AutoYama = value
                ...
                if _G.WalkWater then
                    if game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame.Y <= 1 then
                        if not game:GetService("Workspace"):FindFirstChild("Water") then
                            ...
                            Water.Anchored = true
                            Water.Material = "Neon"
                            Water.Color = Color3.fromRGB(202,60,253)
