...
local BxBLib = {RainbowColorValue = 0, HueSelectionPosition = 0}
...
coroutine.wrap(
	function()
		while wait() do
			BxBLib.RainbowColorValue = BxBLib.RainbowColorValue + 1 / 255
			BxBLib.HueSelectionPosition = BxBLib.HueSelectionPosition + 1

			if BxBLib.RainbowColorValue >= 1 then
				BxBLib.RainbowColorValue = 0
			end

			if BxBLib.HueSelectionPosition == 93 then
				BxBLib.HueSelectionPosition = 0
			end
		end
	end
)()
...
local BxBxyzLib = Instance.new("ScreenGui")
BxBxyzLib.Name = "MarkBeatsIsGay"
if syn and syn.protect_gui then
    syn.protect_gui(BxBxyzLib)
    BxBxyzLib.Parent = game.CoreGui
elseif gethui then
    BxBxyzLib.Parent = gethui()
else
    BxBxyzLib.Parent = game.CoreGui
end
BxBxyzLib.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

function BxBLib:Window()
				...
				function()
					...
					if RainbowColorPicker then
						...
						while RainbowColorPicker do
							CurrentColor.BackgroundColor3 = Color3.fromHSV(BxBLib.RainbowColorValue, 1, 1)
							Color.BackgroundColor3 = Color3.fromHSV(BxBLib.RainbowColorValue, 1, 1)

							ColorSelection.Position = UDim2.new(1, 0, 0, 0)
							HueSelection.Position = UDim2.new(0.48, 0, 0, BxBLib.HueSelectionPosition)
